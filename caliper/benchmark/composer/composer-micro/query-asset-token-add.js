...
module.exports.init = async function(blockchain, context, args) {
	...
	let participant = factory.newResource(namespace, 'User', 'User11@qq.com');
    ...
    for(let i = 0; i < testAssetNum; i ++){
        let userTokenRecharge = factory.newResource(namespace, 'UserTokenRecharge', 'REcharge11_' + i);
        
		userTokenRecharge.user = factory.newRelationship(namespace, 'User', 'User11@qq.com');
		...
		await UserTokenRechargeRegistry.add(userTokenRecharge);
    }
...
module.exports.run = function() {
    ...
    return busNetConnection.query('GetUserTokenRechargeUserR', { user: 'resource:token.User#User11@email.com'})
        .then((result) => {
